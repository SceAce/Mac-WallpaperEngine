...
public:
    ...
    uint32_t      InstanceVertexCount() const { return m_instanceVertexCount; }
    void          SetInstanceVertexCount(uint32_t count) { m_instanceVertexCount = count; }
...
private:
    ...
    uint32_t          m_instanceVertexCount { 0 };
    bool m_dynamic;
