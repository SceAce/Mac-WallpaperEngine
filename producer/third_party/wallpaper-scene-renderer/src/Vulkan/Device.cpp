...
bool Device::Create(Instance& inst,
    ...
    enabled_features.geometryShader       = supported_features.geometryShader;
    enabled_features.textureCompressionBC = supported_features.textureCompressionBC;
    device.m_features                     = enabled_features;
    ...
    device.m_video_tex_cache = CreateVideoTextureCache(device, video_texture_settings);
    return true;
}
