...
const char* ParticleExpansionName(ParticleExpansionMode expansion) noexcept {
    ...
    case ParticleExpansionMode::InstancedStrip: return "InstancedStrip";
    }
    return "unknown";
}
...
bool ValidateParticleMeshContract(const SceneMesh& mesh, const ParticleRenderPlan& plan,
    ...
    const bool expansion_valid =
        ...
        (plan.expansion == ParticleExpansionMode::InstancedStrip && plan.strip_vertices >= 4 &&
         mesh.InstanceVertexCount() == plan.strip_vertices);
