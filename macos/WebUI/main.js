...
const TRANSLATIONS = {
  en: {
    ...
    'aria.appSettings': 'Vivid settings',
    ...
    'display.empty': 'No connected displays reported by Vivid.',
    ...
    'settingOption.gfx-volumetrics.1': 'Low',
    'settingOption.gfx-volumetrics.2': 'Medium',
    'settingOption.gfx-volumetrics.3': 'High',
    'settingOption.gfx-volumetrics.4': 'Ultra',
    'setting.gfx-shadows.name': 'Shadows',
    'settingOption.gfx-shadows.0': 'Disabled',
    'settingOption.gfx-shadows.1': 'Low',
    'settingOption.gfx-shadows.2': 'Medium',
    'settingOption.gfx-shadows.3': 'High',
    'settingOption.gfx-shadows.4': 'Ultra',
    'setting.gfx-postprocessing.name': 'Post-processing',
    'settingOption.gfx-postprocessing.0': 'Disabled',
    'settingOption.gfx-postprocessing.1': 'Enabled',
    'settingOption.gfx-postprocessing.2': 'Ultra',
    'settingOption.gfx-postprocessing.3': 'Ultra (Display HDR)',
    'setting.gfx-antialiasing.name': 'Anti-aliasing',
    'settingOption.gfx-antialiasing.0': 'None',
    ...
    'settingOption.gfx-texture-resolution.2': 'Automatic',
    ...
    'status.connecting': 'Connecting to Vivid...',
  ...
  'zh-CN': {
    ...
    'display.empty': 'Vivid 没有上报已连接显示器。',
    'display.menu': '显示器操作',
    'display.mode': '显示器模式',
    'display.muted': '已静音',
    ...
    'settingOption.gfx-volumetrics.1': '低',
    'settingOption.gfx-volumetrics.2': '中',
    'settingOption.gfx-volumetrics.3': '高',
    'settingOption.gfx-volumetrics.4': '超高',
    'setting.gfx-shadows.name': '阴影',
    'settingOption.gfx-shadows.0': '禁用',
    'settingOption.gfx-shadows.1': '低',
    'settingOption.gfx-shadows.2': '中',
    'settingOption.gfx-shadows.3': '高',
    'settingOption.gfx-shadows.4': '超高',
    'setting.gfx-postprocessing.name': '后处理',
    'settingOption.gfx-postprocessing.0': '禁用',
    'settingOption.gfx-postprocessing.1': '启用',
    'settingOption.gfx-postprocessing.2': '超高',
    'settingOption.gfx-postprocessing.3': '超高（显示 HDR）',
    'setting.gfx-antialiasing.name': '抗锯齿',
    'settingOption.gfx-antialiasing.0': '无',
    'settingOption.gfx-antialiasing.1': 'MSAA x2',
    'settingOption.gfx-antialiasing.2': 'MSAA x4',
    'settingOption.gfx-antialiasing.3': 'MSAA x8',
    ...
    'settingOption.gfx-texture-resolution.2': '自动',
...
const SETTINGS = [
  ...
  },
  {
     ...
     * saved configurations and native control messages. Scene and web renderers
     * use this setting; video playback follows its media clock.
     */
    section: 'general',
    key: 'scene-fps',
    name: 'Frame Rate',
...
function updateStateOutput() {
  /*
   * The native state can grow with per-wallpaper property payloads. Keep the
...
function outputBounds(outputs) {
  /*
   * The native app exposes x/y in compositor logical coordinates, while the
